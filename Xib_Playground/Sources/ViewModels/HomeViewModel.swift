...
final class HomeViewModel: HomeViewModelType, HomeViewModelInputs, HomeViewModelOutputs {
    ...
    private let _isResetButtonHidden = BehaviorRelay<Bool>(value: true)
    ...
    init() {
        ...
        self.isResetButtonHidden = _isResetButtonHidden.asDriver(onErrorDriveWith: .empty())
                ...
                if strongSelf._isTimerRunning.value == true {
                    ...
                    strongSelf.timer = Observable<Int>.interval(.milliseconds(100), scheduler: MainScheduler.instance)
                        .subscribe(onNext: { _ in
                            ...
                            strongSelf._isResetButtonHidden.accept(false)
                        })
        ...
        resetCount
            .subscribe(onNext: { [weak self] _ in
                ...
                self?._isResetButtonHidden.accept(true)
                self?.timer?.dispose()
